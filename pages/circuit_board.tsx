...
import ListBuilder from "../app/components/general-components/listbuilder";
import Wires from "../app/components/circuit-components/wires";
import { Wire } from "../app/types/wire";
import { Gate, QuantumGate } from "../app/types/gate";
import CircuitSidebar from "../app/components/circuit-components/circuit_sidebar"
  ...
  return (
    <div className="bg-background w-full">
      <DndContext onDragEnd={handleDragEnd}>
        <CircuitSidebar />
        <main className="flex flex-col h-full w-full items-center gap-10 ml-10 py-10">
